...
Returns `true` if NumerFlow can animate, i.e.:
...
* The user has not indicated a preference for reduced motion (can be bypassed with `respectMotionPreference: false`)
