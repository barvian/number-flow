...
description: Transition and format numbers. Built on Intl.NumberFormat and WAAPI. Accessible and customizable.
---
...
```jsx
<NumberFlow style={{ '--number-flow-char-height': '0.85em' }} />
```
