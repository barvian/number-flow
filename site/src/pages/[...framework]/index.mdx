...
NumberFlow accepts props to customize the transition timings. Each take a [`KeyframeEffect`](https://developer.mozilla.org/en-US/docs/Web/API/KeyframeEffect/KeyframeEffect#options) object:
...
<Fragment slot="react">
```jsx
<NumberFlow style={{ lineHeight: 0.85 }} />
```
</Fragment>
<Fragment slot="vue">
```vue
