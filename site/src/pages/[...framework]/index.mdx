...
// import OverridesDemo from './_demos/Overrides'
...
<h3>
	<code>overrides<Type>: Record{'<string, string>'}</Type></code>
</h3>

Overrides for symbol values, e.g. for currencies not supported by `Intl.NumberFormat`:

{/*<OverridesDemo client:visible defaultValue='code'>*/}
<Match react>
```jsx
<NumberFlow
	value={value}
