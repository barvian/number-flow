...
* The user has not indicated a preference for reduced motion (optional, see [`respectMotionPreference`](#respect-motion-preference))
...
Returns `true` if NumerFlow can animate.
