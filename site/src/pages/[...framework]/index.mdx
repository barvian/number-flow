...
<Match>
<Heading slot="vue" value="Events"/>
</Match>

<Match>
<h3 slot="react"><code>onAnimationsStart<Type>: () => void</Type></code></h3>
<h3 slot="vue"><code>animationsstart</code></h3>
</Match>
...
<Match>
<h3 slot="react"><code>onAnimationsFinish<Type>: () => void</Type></code></h3>
<h3 slot="vue"><code>animationsfinish</code></h3>
</Match>
...
<Match><Fragment slot="react">See the [Framer Motion example](/examples#framer-motion) for a usage scenario.</Fragment></Match>
...
<Match><Fragment slot="react">I'd recommend using Framer Motion for these, as it's more composable than any built-in solution could be. See the Framer Motion layout animations [example](/examples#framer-motion).</Fragment></Match>
