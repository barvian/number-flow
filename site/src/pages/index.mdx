...
until the layout animation ends. If you want the opacity transition to look shorter than the layout animation,
...
as they seem to work better. Also, if you're using [`<MotionConfig>`](https://www.framer.com/motion/motion-config/) to set a transition, make sure to check the
